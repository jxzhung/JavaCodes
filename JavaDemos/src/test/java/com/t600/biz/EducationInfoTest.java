...
public class EducationInfoTest {
    ...
    public static void main(String[] args) {
        EducationInfoTest test = new EducationInfoTest();
        test.savePostCode();
    }

    public void savePostCode() {
        String xlsFilePath = "C:\\Users\\Jzhung\\Desktop\\教育局信息\\河南省.xlsx";
        ...
        try {
            ...
            for (int i1 = startRow - 1; i1 < rows; i1++) {
                ...
                // 设置电话和地址信息
                /*Cell addressCell = row.getCell(ADDRESSS);
                if(addressCell != null){
                    String address = getValue(addressCell).trim().replace("#", "");
                ...
                ContractInfo contraceInfo = ContactUtil.getContraceInfo(name + "教育局");
