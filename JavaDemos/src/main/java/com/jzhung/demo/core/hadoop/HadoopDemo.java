...
public class HadoopDemo {
     ...
     * @param conf
     */
    public HadoopDemo(Configuration conf) {
        this(HDFS, conf);
    }

    public HadoopDemo(String hdfs, Configuration conf) {
        this.hdfsPath = hdfs;
        this.conf = conf;
    }
    ...
    public static void main(String[] args) throws IOException {
        JobConf conf = config();
        conf.setUser("admin");
        HadoopDemo hdfs = new HadoopDemo(conf);
...
//      hdfs.rename("/out.txt", "/out");
    ...
    public static JobConf config() {
        ...
        conf.addResource("D:\\ceshi\\hadoop\\core-site.xml");
        conf.addResource("D:\\ceshi\\hadoop\\hdfs-site.xml");
